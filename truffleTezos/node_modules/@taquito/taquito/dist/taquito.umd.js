    ...
    ***************************************************************************** */
                ...
                return __generator(this, function (_j) {
                    switch (_j.label) {
                        ...
                        case 3:
                            ...
                            _b = param.kind;
                            switch (_b) {
                                case 'transaction': return [3 /*break*/, 4];
                                case 'origination': return [3 /*break*/, 6];
                                case 'delegation': return [3 /*break*/, 8];
                                case 'activate_account': return [3 /*break*/, 10];
                            }
                            return [3 /*break*/, 11];
                        case 4:
    ...
    var OperationBatch = /** @class */ (function (_super) {
        ...
        OperationBatch.prototype.withTransfer = function (params) {
            this.operations.push(__assign({ kind: 'transaction' }, params));
            return this;
        };
        /**
         *
        ...
        OperationBatch.prototype.withDelegation = function (params) {
            this.operations.push(__assign({ kind: 'delegation' }, params));
            return this;
        };
        /**
         *
        ...
        OperationBatch.prototype.withActivation = function (_a) {
            ...
            this.operations.push({ kind: 'activate_account', pkh: pkh, secret: secret });
            return this;
        };
        /**
         *
        ...
        OperationBatch.prototype.withOrigination = function (params) {
            this.operations.push(__assign({ kind: 'origination' }, params));
            return this;
        };
                ...
                return __generator(this, function (_f) {
                    switch (_f.label) {
                        ...
                        case 2:
                            ...
                            op = _a[_i];
                            if (!(op.kind !== 'activate_account')) return [3 /*break*/, 5];
